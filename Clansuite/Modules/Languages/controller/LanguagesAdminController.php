...
namespace Clansuite\Modules\Languages\controller;
 ...
 */
class LanguagesAdminController extends ModuleController
{
    ...
    public static function createLanguage($module, $locale)
    {
        ...
        if (false === is_file($file)) {
            ...
            include KOCH_FRAMEWORK . 'gettext.core.php';
    ...
    public function action_admin_edit()
    {
        if ($this->request->getRequestMethod() == 'GET') {
             ...
             */
            include KOCH_FRAMEWORK . 'gettext/po.gettext.php';
