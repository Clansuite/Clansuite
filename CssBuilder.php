 ...
 *  - administration der css dateien über editor im admin
 *  - mit dem builder diese nach änderung neu kompriemieren
 *
*/
...
// -------------------------------------------------------------------------------------------------
{
    ...
    foreach( $coreFiles as $filename ) {
        $content = _load_stylesheet($corePath.$filename);
...
function getCompactHeader( $patch = '' )
{
    ...
    switch($patch) {
        case 'ie':
            ...
            $compact .= " * Jens-André Koch © 2005 - onwards"."\n";
