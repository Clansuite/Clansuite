...
class German implements \ArrayAccess
{
    ...
    public function __construct()
    {
        ...
        $this->language['IS_WRITABLE_TEMP_DIR'] = 'Nutzbar: Temporäres Verzeichnis';
        $this->language['IS_WRITABLE_CLANSUITE_ROOT'] = 'Beschreibbar: "/Clansuite"';
        $this->language['IS_WRITABLE_CACHE_DIR'] = 'Beschreibbar: "/Clansuite/Cache"';
        $this->language['IS_WRITABLE_UPLOADS'] = 'Beschreibbar: "/Clansuite/Uploads"';
        $this->language['IS_WRITABLE_CONFIGURATION'] = 'Beschreibbar: "/Clansuite/Configuration"';
