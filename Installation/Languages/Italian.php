...
class Italian implements \ArrayAccess
{
    ...
    public function __construct()
    {
        ...
        $this->language['IS_WRITABLE_CLANSUITE_ROOT'] = 'Posso Scrivere: "/Clansuite"';
        $this->language['IS_WRITABLE_CACHE_DIR'] = 'Posso Scrivere: "/Clansuite/Cache"';
        $this->language['IS_WRITABLE_UPLOADS'] = 'Posso Scrivere: "/Clansuite/Uploads"';
        $this->language['IS_WRITABLE_CONFIGURATION'] = 'Posso Scrivere: "/Clansuite/Configuration"';
        ...
        $this->language['STEP6_ADMIN_NAME_TOOLTIP']     = 'Selezionare prego il nome dell\'account di amministratore. Dopo, � possibile utilizzarlo per il login.';
        $this->language['STEP6_ADMIN_PASSWORD_TOOLTIP'] = 'Inserire prego la password per l\'account di amministratore.';
        $this->language['STEP6_ADMIN_LANGUAGE_TOOLTIP'] = 'Selezionare prego la lingua per l\'account amministratore.';
        $this->language['STEP6_ADMIN_EMAIL_TOOLTIP']    = 'Inserire prego l\'email per l\'account di amministratore. Dopo, � possibile utilizzarlo per il login.';
