...
class config
{
	function __construct()
	{
		...
		$this->tpl_folder	= 'admin/templates';
		...
		$this->std_page_title		= 'Clansuite Control Center';
		...
		$this->copyright	= 'clansuite.com | (c) 2006 GPL v2 License (see COPYING.txt)';
