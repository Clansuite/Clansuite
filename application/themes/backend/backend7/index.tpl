...
<html><head>
    ...
    <link rel="stylesheet" type="text/css" href="{$www_root_themes_backend}backend7/css/backend.css" />
    <link rel="stylesheet" type="text/css" href="{$www_root_themes_backend}backend7/css/custom/jquery-ui-1.7.2.custom.css" />
...
<div id="header">
	<div class="inside">
		...
		<div class="logo"><img class="logo" src="{$www_root_themes_backend}backend7/images/logo_backend.gif" width="197px" height="91px" alt="backend_logo" /></div>
    ...
    <td valign="top" id="main_left">
    	<div class="inside">
			<div id="rss-news">													<!-- Start rss-news -->
            	<div class="box-head">
                	<img class="leftcorner" src="{$www_root_themes_backend}backend7/images/title_leftcorner.jpg" />
