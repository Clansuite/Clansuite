...
class Clansuite_Loader
{
    ...
    public function __construct()
    {
        ...
        $file = getcwd() . '/configuration/autoloader.config.php';
    ...
    {
        /**
         * Note 1 : delete the autoloader.config.php file, if you get an unserialization error like "error at offset xy"
         * Note 2 : levate getcwd(), because Paths like ROOT are defined after the loader
         */
        return unserialize(file_get_contents(getcwd() . '/configuration/autoloader.config.php'));
    }
    ...
    public function autoload($classname)
    {
        ...
        $filenames = array (
            ...
            ROOT_CORE . 'filters/' . substr($filename, 7) . '.filter.php',
            # Event
     ...
     */
    public static function callClassMethod($class, string $method, array $arguments = array())
    {
     ...
     * @param array $arguments Array of Arguments for the Method Call.
     *
     * @return object / method response
     */
    public static function callMethod(string $method, array $arguments = array())
    {
        switch (count($arguments))
        {
            case 0:
