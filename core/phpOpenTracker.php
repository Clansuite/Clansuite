...
2000-2005 Sebastian Bergmann <sb@sebastian-bergmann.de>
...
class phpOpenTracker
{
    ...
    */
    function log($parameters = array())
    {
        ...
        {
            return phpOpenTracker::handleError('phpOpenTracker::log() may only be called once per request.');
        }
        ...
        return $le->log(isset($parameters['add_data']) ? $parameters['add_data'] : array());
    }
