...
class Clansuite_Browserinfo
{
    ...
    public function detect()
    {
        ...
        if ( preg_match("/beos/i", $this->useragent) ) $this->useros = "BeOS";
        ...
        if ( preg_match( "/Safari/i", $this->useragent ) && !preg_match( "/Chrome/i", $this->useragent ) ) { 
    ...
    public function getBuilVersion()
    {
    ...
    {
        return (  preg_match("/gecko/i", $this->useragent) && 
                    preg_match("/rv:/i", $this->useragent) && 
                    !preg_match("/(netscape)|(navigator)|(phoenix)|(firebird)|(firefox)|(kmeleon)|(k-meleon)|(camino)|(chimera)|(konqueror)|(galeon)|(epiphany)|(seamonkey)/i", $this->useragent) && 
    ...
    {
        return (  preg_match("/mozilla\/5/i", $this->useragent) && 
                    !preg_match("/(opera)/i", $this->useragent) && 
                    $this->is_Ver($iVal) ) ? 1 : 0;
    }
    ...
    {
        return (  preg_match("/Mozilla\/4.[0-9]+/i", $this->useragent) && 
    ...
    { 
        return ( preg_match("/(safari)/i", $this->useragent) && 
                   !preg_match("/(chrome)/i", $this->useragent) && 
                   $this->is_Ver($iVal) ) ? 1 : 0;
    }
    ...
    { 
        return ( preg_match("/(chrome)/i", $this->useragent) && 
                   $this->is_Ver($iVal) ) ? 1 : 0;
    }
    ...
    public function transparentpng( $png )
    {
        ...
        $cla = ( $this->isIE() && $this->browserversion < 7) 
                    ? "filter:progid:DXImageTransform.Microsoft.AlphaImageLoader(src='$png', sizingMethod='image');" 
