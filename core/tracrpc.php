...
class Trac_RPC
{
	 ...
	 */
	function getRecentChangedWikiPages($date=0)
	{
		if($date == false)
		{
	 ...
	 * @return	mixed	The result of the requet or the integer id on a muli_call. false on error.
	 */
	function getRecentChangedTickets($date=0)
	{
		if($date == false)
		{
			$date = array('datetime', date("o-m-d\T00:00:00"));
	 ...
	 * @return	mixed	The result of the requet or the integer id on a muli_call. false on error.
	 */
	function getTicketChangelog($id='', $when=0)
	{
		if($id == '')
		{
			return false;
	 ...
	 * @return	mixed	The result of the requet or the integer id on a muli_call. false on error.
	 */
	function ticketComponent($action='get_all', $name='', $attr=array())
	{
		$method = '';
		$params = '';
	 ...
	 * @return	mixed	The result of the requet or the integer id on a muli_call. false on error.
	 */
	function getTicketMilestone($action='get_all', $name='', $attr=array())
	{
		$method = '';
		$params = '';
	 ...
	 * @return	mixed	The result of the requet or the integer id on a muli_call. false on error.
	 */
	function getTicketPriority($action='get_all', $name='', $attr='')
	{
		$method = '';
		$params = '';
