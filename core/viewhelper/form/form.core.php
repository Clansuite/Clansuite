    ...
    */
    ...
    public function regenerateFormelementIdentifiers()
    {
       ...
       foreach($this->formelements as $formelement)
       {
           ...
           /**
            *  the autogenerated id string has the following format
            *  "type-formelement-id"
            *  id is stripped off of the id string and the new id is appended.
            */
    ...
    protected function getDataArray()
    {
        ...
        if ($method === 'GET')
        {
            return Clansuite_HttpRequest::getGet();
        }

        if ($method === 'POST')
        {
            return Clansuite_HttpRequest::getPost();
        }
    }
