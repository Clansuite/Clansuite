<?php
    ...
    *
    * @version    SVN: $Id: view_smarty.class.php 2084 2008-06-11 00:00:41Z vain $
    */
...
class view_smarty_clean extends renderer_base
{
    /**
    ...
    function __construct(Phemto $injector = null)
    {
       ...
       */
       if (!class_exists('Smarty')) // prevent redeclaration
       {
          ...
          {
              require_once(ROOT_LIBRARIES . '/smarty/Smarty.class.php');
              #$this->smarty = new Smarty();
              require_once(ROOT_LIBRARIES . '/smarty/Render_SmartyDoc.class.php');
   ...
   /**
    ...
    public function loadModule($module_name)
    {
        ...
        */
        ...
        $controller->setRenderEngine('smarty_clean');
        ...
        */
        $this->smarty->assign_by_ref($module_name, $controller);
    ...
    public function render($template)
    {
        ...
        # $this->smarty->assign_by_ref('cs', parent);
