...
Das Verzeichnis Themes enthält zunächst die drei Verzeichnisse frontend, backend und core.
...
Systemweit verfügbare Bilder, Javascript, CSS, Schriften und Templates werden
