...
*ROOT*::
    ...
    getcwd()
*ROOT_CACHE*::
    Verzeichnis für das Caching = ROOT . 'cache' . DIRECTORY_SEPARATOR
*ROOT_CONFIG*::
    Verzeichnis für die Konfiguration = ROOT . 'configuration' . DIRECTORY_SEPARATOR
*ROOT_FRAMEWORK*::
    Verzeichnis des Clansuite Cores = ROOT . 'core' . DIRECTORY_SEPARATOR
*ROOT_LANGUAGES*::
    Verzeichnis der Sprachen = ROOT . 'languages' . DIRECTORY_SEPARATOR
*ROOT_LOGS*::
    Verzeichnis für das Logging = ROOT . 'logs' . DIRECTORY_SEPARATOR
*ROOT_LIBRARIES*::
    Verzeichnis der Bibliotheken = ROOT . 'libraries' . DIRECTORY_SEPARATOR
*ROOT_MOD*::
    Verzeichnis der Module = ROOT . 'modules' . DIRECTORY_SEPARATOR
*ROOT_THEMES*::
    Verzeichnis der Themes = ROOT . 'themes' . DIRECTORY_SEPARATOR
*ROOT_UPLOAD*::
    Verzeichnis für den Upload = ROOT . 'uploads' . DIRECTORY_SEPARATOR
****
