...
welches Images und Icons für die Toolbar beinhaltet. Die Verzeichnisnamen sind zwingend kleinzuschreiben.

image:images/chapter12/Toolbar-20-SvnDirStructure.png[Das Bild zeigt die SVN Verzeichnisstruktur der Clansuite Toolbar.]

image:images/chapter12/Toolbar-21-FilesMainDir.png[Das Bild zeigt das Hauptverzeichnis der Clansuite Toolbar.]
