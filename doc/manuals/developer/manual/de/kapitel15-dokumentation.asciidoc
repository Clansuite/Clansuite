...
zunächst der Clansuite Quellcode geparsed und anschließend analysiert. Doxygen beherrscht die Kunst, das
...
Seit PHP5 bietet PHP die Reflection API an. Damit ist es möglich Objekte und Klassen per Introspektion zu untersuchen.
