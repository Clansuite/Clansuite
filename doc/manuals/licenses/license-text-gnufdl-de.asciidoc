...
GNU Free Documentation License, Version 1.3 oder jeder späteren
...
mit den unveränderlichen Abschnitten AUFGELISTET NACH TITELN, mit
den vorderen Umschlagtexten AUFGELISTET und mit den hinteren
Umschlagtexten AUFGELISTET.
...
==== Hinweis auf die Inoffizielle Übersetzung der GNU Free Documentation License (FDL) Version 1.3
...
Diese inoffizielle Übersetzung ins Deutsche entstammt der Webseite von Ingo Rybaczyk.
Diese Textfassung hat das letzte Abfrufdatum des 31.07.2009.
Die aktuellste Version der Übersetzung findet man unter der Internetadresse (URL) http://rybaczyk.freeunix.net/licenses/fdl-1.3.de.html.
