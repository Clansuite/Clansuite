...
INSERT INTO `cs_adminmenu_backup` VALUES (1,0,'folder','Home','index.php?mod=admin','Home','_self',0,''),(2,0,'folder','Modules','','Modules','_self',1,''),(3,2,'folder','News','','News','_self',0,'page_edit.png'),(4,3,'item','Manage News','index.php?mod=news&sub=admin','Manage News','_self',0,'application_form_edit.png'),(5,2,'folder','Articles','','Articles','_self',1,'report.png'),(6,2,'folder','Static Pages','','Static Pages','_self',2,'html.png'),(7,6,'item','Create new Static Page','index.php?mod=static&sub=admin&action=create','Create new Static Page','_self',0,'add.png'),(8,6,'item','Show Static Pages','index.php?mod=static&sub=admin','Show Static Pages','_self',1,'pencil.png'),(9,2,'folder','Forum','','Forum','_self',3,'application_view_list.png'),(10,2,'folder','Guestbook','index.php?mod=guestbook&action=show','Guestbook','_self',4,'book_open.png'),(11,2,'folder','Matches','index.php?mod=matches&action=show','Matches','_self',5,'database_go.png'),(12,2,'folder','Serverlist','','Serverlist','_self',6,'table.png'),(13,12,'item','Show Servers','index.php?mod=serverlist&sub=admin&action=show','Show Servers','_self',0,'application_view_list.png'),(14,12,'item','Add Server','index.php?mod=serverlist&action=show','Add Server','_self',1,'application_form_edit.png'),(15,2,'folder','Shoutbox','','Shoutbox','_self',7,'comment.png'),(16,2,'folder','Downloads','','Downloads','_self',8,'disk.png'),(17,2,'folder','Gallery','','Gallery','_self',9,'map_go.png'),(18,2,'folder','Replays','','Replays','_self',10,'film.png'),(19,2,'folder','eMail','','eMail','_self',11,'email_open_image.png'),(20,0,'folder','System','','System','_self',2,''),(21,20,'item','Settings','index.php?mod=admin&sub=config','Settings','_self',0,'settings.png'),(22,20,'folder','Database','','Database','_self',1,'database_gear.png'),(23,22,'item','Optimize','index.php?mod=database&action=optimize','Optimize','_self',0,'database_go.png'),(24,22,'item','Backup','index.php?mod=database&action=backup','Backup','_self',1,'database_key.png'),(25,20,'folder','Modules','','Modules','_self',2,'bricks.png'),(26,25,'item','Install new modules','index.php?mod=admin&sub=modules&action=install_new','Install new modules','_self',0,'package.png'),(27,25,'item','Create a module/submodule','index.php?mod=admin&sub=modules&action=create_new','Create a new module/submodule','_self',1,'add.png'),(28,25,'item','Show and edit modules','index.php?mod=admin&sub=modules&action=show_all','Show and edit modules','_self',2,'bricks_edit.png'),(29,25,'item','Export a module','index.php?mod=admin&sub=modules&action=export','Export a module','_self',3,'compress.png'),(30,20,'folder','Language','','Language','_self',3,'spellcheck.png'),(31,30,'item','Language Editor','index.php?mod=language&sub=editor','Language Editor','_self',0,'spellcheck.png'),(32,0,'folder','Administration','','Administration','_self',3,''),(33,32,'folder','Users','','Users','_self',0,'user_suit.png'),(34,33,'item','Show all Users','index.php?mod=admin&sub=users','Show all Users','_self',0,'table.png'),(35,33,'item','Create a user','index.php?mod=admin&sub=users&action=create','Create a user','_self',1,'add.png'),(36,33,'item','Search a User','index.php?mod=admin&sub=users&action=search','Search a User','_self',2,'magnifier.png'),(37,32,'folder','Groups','','Groups','_self',1,'group.png'),(38,37,'item','Show all Groups','index.php?mod=admin&sub=groups','Show all Groups','_self',0,'table.png'),(39,37,'item','Create a group','index.php?mod=admin&sub=groups&action=create','Create a group','_self',1,'add.png'),(40,32,'folder','Permissions','','Permissions','_self',2,'key.png'),(41,40,'item','Show all Permissions','index.php?mod=admin&sub=permissions','Show all Permissions','_self',0,'table.png'),(42,32,'item','Categories','index.php?mod=admin&sub=categories','Categories','_self',3,'spellcheck.png'),(43,32,'folder','Layout & Styles','','Layout & Styles','_self',4,'layout_header.png'),(44,43,'item','Adminmenu Editor','index.php?mod=admin&sub=menueditor','Adminmenu Editor','_self',0,'application_form_edit.png'),(45,43,'item','Template Editor','index.php?mod=admin&sub=templates','Template Editor','_self',1,'layout_edit.png'),(46,0,'folder','Help','','Help','_self',4,''),(47,46,'item','Help','index.php?mod=admin&sub=static&action=show&page=help','Help','_self',0,'help.png'),(48,46,'item','Manual','index.php?mod=admin&sub=manual','Manual','_self',1,'book_open.png'),(49,46,'item','Report Bugs & Give Feedback','index.php?mod=admin&sub=bugs','Report Bugs & Give Feedback','_self',2,'error.png'),(50,46,'item','About Clansuite','index.php?mod=admin&sub=static&action=show&page=about','About Clansuite','_self',3,'information.png');
