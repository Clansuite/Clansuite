...
INSERT INTO `cs_adminmenu` VALUES (1,0,'folder','Home','index.php?mod=admin','Home','_self',0,''),(2,0,'folder','Modules','','Modules','_self',1,''),(3,2,'folder','Articles','','Articles','_self',0,'report.png'),(4,2,'folder','Downloads','','Downloads','_self',1,'disk.png'),(5,2,'folder','eMail','','eMail','_self',2,'email_open_image.png'),(6,2,'folder','Forum','','Forum','_self',3,'application_view_list.png'),(7,2,'folder','Gallery','','Gallery','_self',4,'map_go.png'),(8,2,'folder','News','','News','_self',5,'page_edit.png'),(9,2,'folder','Replays','','Replays','_self',6,'film.png'),(10,2,'folder','Shoutbox','','Shoutbox','_self',7,'comment.png'),(11,2,'folder','Static Pages','','Static Pages','_self',8,'html.png'),(12,11,'item','Create','index.php?mod=admin&sub=static&action=create','Create','_self',0,'add.png'),(13,11,'item','Edit','index.php?mod=admin&sub=static&action=list_all','Edit','_self',1,'pencil.png'),(14,0,'folder','System','','System','_self',2,''),(15,14,'item','Settings','index.php?mod=admin&sub=config','Settings','_self',0,'settings.png'),(16,14,'item','Categories','index.php?mod=admin&sub=categories','Categories','_self',1,'spellcheck.png'),(17,14,'folder','Modules','','Modules','_self',2,'bricks.png'),(18,17,'item','Install new modules','index.php?mod=admin&sub=modules&action=install_new','Install new modules','_self',0,'package.png'),(19,17,'folder','Development','','Development','_self',1,'application_xp_terminal.png'),(20,19,'item','Create a module','index.php?mod=admin&sub=modules&action=create_new','Create a new module','_self',0,'add.png'),(21,19,'item','Export a module','index.php?mod=admin&sub=modules&action=export','Export a module','_self',1,'compress.png'),(22,19,'item','Edit modules','index.php?mod=admin&sub=modules&action=show_all','Edit modules','_self',2,'bricks_edit.png'),(23,14,'folder','Development','','Development','_self',3,'application_xp_terminal.png'),(24,23,'item','Template Editor','index.php?mod=admin&sub=templates','Template Editor','_self',0,'layout_edit.png'),(25,23,'item','Adminmenu Editor','index.php?mod=admin&sub=menueditor','Adminmenu Editor','_self',1,'application_form_edit.png'),(26,0,'folder','Administration','','Administration','_self',3,''),(27,26,'folder','Users','','Users','_self',0,'user_suit.png'),(28,27,'item','Show all Users','index.php?mod=admin&sub=users','Show all Users','_self',0,'table.png'),(29,27,'item','Create a user','index.php?mod=admin&sub=users&action=create','Create a user','_self',1,'add.png'),(30,27,'item','Search a User','index.php?mod=admin&sub=users&action=search','Search a User','_self',2,'magnifier.png'),(31,26,'folder','Groups','','Groups','_self',1,'group.png'),(32,31,'item','Show all Groups','index.php?mod=admin&sub=groups','Show all Groups','_self',0,'table.png'),(33,31,'item','Create a group','index.php?mod=admin&sub=groups&action=create','Create a group','_self',1,'add.png'),(34,26,'folder','Permissions','','Permissions','_self',2,'key.png'),(35,34,'item','Show all Permissions','index.php?mod=admin&sub=permissions','Show all Permissions','_self',0,'table.png'),(36,26,'folder','Templates','','Templates','_self',3,'layout_header.png'),(37,0,'folder','Help','','Help','_self',4,''),(38,37,'item','Help','index.php?mod=admin&sub=static&action=show&page=help','Help','_self',0,'help.png'),(39,37,'item','Manual','index.php?mod=admin&sub=manual','Manual','_self',1,'book_open.png'),(40,37,'item','Report Bugs & Give Feedback','index.php?mod=admin&sub=bugs','Report Bugs & Give Feedback','_self',2,'error.png'),(41,37,'item','About Clansuite','index.php?mod=admin&sub=static&action=show&page=about','About Clansuite','_self',3,'information.png');
...
INSERT INTO `cs_adminmenu_old` VALUES (1,0,'folder','Home','index.php?mod=admin','Home','_self',0,''),(2,0,'folder','Modules','','Modules','_self',1,''),(3,2,'folder','Articles','','Articles','_self',0,'report.png'),(4,2,'folder','Downloads','','Downloads','_self',1,'disk.png'),(5,2,'folder','eMail','','eMail','_self',2,'email_open_image.png'),(6,2,'folder','Forum','','Forum','_self',3,'application_view_list.png'),(7,2,'folder','Gallery','','Gallery','_self',4,'map_go.png'),(8,2,'folder','News','','News','_self',5,'page_edit.png'),(9,2,'folder','Replays','','Replays','_self',6,'film.png'),(10,2,'folder','Shoutbox','','Shoutbox','_self',7,'comment.png'),(11,2,'folder','Static Pages','','Static Pages','_self',8,'html.png'),(12,11,'item','Create','index.php?mod=admin&sub=static&action=create','Create','_self',0,'add.png'),(13,11,'item','Edit','index.php?mod=admin&sub=static&action=list_all','Edit','_self',1,'pencil.png'),(14,0,'folder','System','','System','_self',2,''),(15,14,'item','Settings','index.php?mod=admin&sub=config','Settings','_self',0,'settings.png'),(16,14,'folder','Modules','','Modules','_self',2,'bricks.png'),(17,16,'item','Install new modules','index.php?mod=admin&sub=modules&action=install_new','Install new modules','_self',0,'package.png'),(18,16,'folder','Development','','Development','_self',1,'application_xp_terminal.png'),(19,18,'item','Create a module','index.php?mod=admin&sub=modules&action=create_new','Create a new module','_self',0,'add.png'),(20,18,'item','Export a module','index.php?mod=admin&sub=modules&action=export','Export a module','_self',1,'compress.png'),(21,18,'item','Edit modules','index.php?mod=admin&sub=modules&action=show_all','Edit modules','_self',2,'bricks_edit.png'),(22,14,'folder','Development','','Development','_self',3,'application_xp_terminal.png'),(23,22,'item','Template Editor','index.php?mod=admin&sub=templates','Template Editor','_self',0,'layout_edit.png'),(24,22,'item','Adminmenu Editor','index.php?mod=admin&sub=menueditor','Adminmenu Editor','_self',1,'application_form_edit.png'),(25,0,'folder','Administration','','Administration','_self',3,''),(26,25,'folder','Users','','Users','_self',0,'user_suit.png'),(27,26,'item','Show all Users','index.php?mod=admin&sub=users','Show all Users','_self',0,'table.png'),(28,26,'item','Create a user','index.php?mod=admin&sub=users&action=create','Create a user','_self',1,'add.png'),(29,26,'item','Search a User','index.php?mod=admin&sub=users&action=search','Search a User','_self',2,'magnifier.png'),(30,25,'folder','Groups','','Groups','_self',1,'group.png'),(31,30,'item','Show all Groups','index.php?mod=admin&sub=groups','Show all Groups','_self',0,'table.png'),(32,30,'item','Create a group','index.php?mod=admin&sub=groups&action=create','Create a group','_self',1,'add.png'),(33,25,'folder','Permissions','','Permissions','_self',2,'key.png'),(34,33,'item','Show all Permissions','index.php?mod=admin&sub=permissions','Show all Permissions','_self',0,'table.png'),(35,25,'folder','Templates','','Templates','_self',3,'layout_header.png'),(36,0,'folder','Help','','Help','_self',4,''),(37,36,'item','Help','index.php?mod=admin&sub=static&action=show&page=help','Help','_self',0,'help.png'),(38,36,'item','Manual','index.php?mod=admin&sub=manual','Manual','_self',1,'book_open.png'),(39,36,'item','Report Bugs & Give Feedback','index.php?mod=admin&sub=bugs','Report Bugs & Give Feedback','_self',2,'error.png'),(40,36,'item','About Clansuite','index.php?mod=admin&sub=static&action=show&page=about','About Clansuite','_self',3,'information.png'),(41,14,'item','Categories','index.php?mod=admin&sub=categories','Categories','_selef',1,'spellcheck.png');
...
CREATE TABLE `cs_help` (
  `help_id` int(5) NOT NULL auto_increment,
