<?php
    ...
    *
    * File:         computer.module.php
    * Requires:     PHP 5.1.4+
    *
    * Purpose:      Clansuite Module Class - computer
    *               The computer profile of an user
    *
    * LICENSE:
    *
...
/**
 * This is the Clansuite Module Class - module_account_computer
 *
 * Description:  The computer profile of an user
 *
 ...
 * @package     clansuite
 * @category    module
 * @subpackage  module_account_computer
 */
class module_account_computer
{
    public $output          = '';
    ...
    /**
     * @desc General Function Hook of computer-Modul
     *
    ...
    function auto_run()
    {
        ...
        $trail->addStep($lang->t('Computer Profile'), 'index.php?mod=computer');
        ...
        switch ($_REQUEST['action'])
        {
            ...
            default:
            case 'show':
                $trail->addStep($lang->t('Show'), 'index.php?mod=computer&amp;action=show');
                $this->show();
                break;
    ...
    */
    function show()
    {
        ...
        $this->output .= $tpl->fetch('account/profile/computer.tpl');
        $this->suppress_wrapper = 1;
    }

    /**
    * Edit the computer profile stuff
    *
    * @global $db
    * @global $lang
    * @global $tpl
    */
     ...
     * {mod name="computer" sub="admin" func="instant_show" params="mytext"}
