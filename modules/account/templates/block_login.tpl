...
{/literal}
    ...
    <form action="index.php?mod=account&action=login{if $referer|count_characters > 0}&referer={$referer}{/if}" method="post" id="block_login_form">
    <table cellpadding="0" cellspacing="0" border="0" width="100%">
        ...
        <tr>
            <td>{t}Password:{/t}</td>
            <td><input class="input_text" type="password" name="password" id="block_password" value="" autocomplete="off" /></td>
        </tr>
        <tr>
            <td colspan="2">
