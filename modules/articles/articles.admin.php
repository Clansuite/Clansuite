...
/**
* articles
* The articles module to write some stuff
*
* PHP >= version 5.1.4
*
* LICENSE:
...
class module_articles_admin
{
    ...
    */
    ...
    function auto_run()
    {
        ...
        $trail->addStep($lang->t('Articles'), '/index.php?mod=Articles&sub=admin');
    ...
    */
    ...
    /**
    * @desc This content can be instantly displayed by adding {mod name="articles" sub="admin" func="instant_show" params="mytext"} into a template
