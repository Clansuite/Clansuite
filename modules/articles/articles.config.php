...
// {mod name="articles" func="show" sub="mysubmodule" params="myparams"}
// 
...
$info['timestamp']      = 1171003347;
$info['name']           = 'articles';
$info['title']          = 'Articles';
$info['description']    = 'The articles module to write some stuff';
$info['class_name']     = 'module_articles';
