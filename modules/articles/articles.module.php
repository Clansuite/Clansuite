...
/**
* Modulename:   articles
* Description:  The articles module to write some stuff
*
* PHP >= version 5.1.4
*
* LICENSE:
...
// Begin of class module_articles
class module_articles
{
    ...
    /**
    * @desc General Function Hook of articles-Modul
    *
    ...
    * {mod name="articles" func="instant_show" params="mytext"}
    *
