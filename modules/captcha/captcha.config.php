...
// {mod name="captcha" func="show" sub="mysubmodule" params="myparams"}
// 
...
$info['timestamp']      = 1156780749;
$info['name']           = 'captcha';
$info['title']          = 'Captcha Module';
$info['description']    = 'The captcha module presents a image only humanoids can read.';
$info['class_name']     = 'module_captcha';
$info['file_name']      = 'captcha.module.php';
$info['folder_name']    = 'captcha';
$info['image_name']     = 'module_captcha.jpg';
