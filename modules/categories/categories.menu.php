...
/**
 * Clansuite Modulenavigation for Module Categories
 */
...
$modulenavigation = array(
                            '1' => array(
                                            'action'  => 'show',
                                            'name'    => 'Overview',
                                            'url'      => 'index.php?mod=categories&sub=admin', # &action=show
                                            'icon'    => '',
                                            'title' => ''
                                        ),
                            ...
                            '2' => array(
                                            'action'  => 'create',
                                            'name'    => 'Create new',
                                            'url'     => 'index.php?mod=categories&sub=admin&action=create',
                                            'icon'    => '',
                                            'title' => ''
                                        ),
                            /*
