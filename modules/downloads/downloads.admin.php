...
/**
* downloads
* The download area of clansuite
*
* PHP >= version 5.1.4
*
* LICENSE:
...
class module_downloads_admin
{
    ...
    */
    ...
    /**
    * @desc This content can be instantly displayed by adding {mod name="downloads" sub="admin" func="instant_show" params="mytext"} into a template
