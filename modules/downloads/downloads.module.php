...
* Description:  The download area of clansuite
*
* PHP >= version 5.1.4
*
* LICENSE:
...
// Begin of class module_downloads
class module_downloads
{
    ...
    /**
    * @desc General Function Hook of downloads-Modul
    *
    ...
    * {mod name="downloads" func="instant_show" params="mytext"}
    *
