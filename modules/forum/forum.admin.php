...
class module_forum_admin
{
    ...
    */
    ...
    /**
    * @desc This content can be instantly displayed by adding {mod name="forum" sub="admin" func="instant_show" params="mytext"} into a template
