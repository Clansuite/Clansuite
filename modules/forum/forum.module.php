...
/**
* Modulename:   forum
* Description:  The forum where people meet
*
* PHP >= version 5.1.4
*
* LICENSE:
...
class module_forum
{
    ...
    /**
    * @desc General Function Hook of forum-Modul
    *
    ...
    * {mod name="forum" func="instant_show" params="mytext"}
    *
