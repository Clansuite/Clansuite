...
/**
* Modulename:   gallery
* Description:  The gallery module of clansuite
*
* PHP >= version 5.1.4
*
* LICENSE:
...
class module_gallery
{
    ...
    /**
    * @desc General Function Hook of gallery-Modul
    *
    ...
    * {mod name="gallery" func="instant_show" params="mytext"}
    *
