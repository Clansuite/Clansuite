 ...
 */
class Module_Guestbook_Admin extends ModuleController implements Clansuite_Module_Interface
{
    ...
    */
    function action_admin_show()
    {
        ...
        # Set Pagetitle and Breadcrumbs
        trail::addstep( _('Show'), '/index.php?mod=guestbook&amp;sub=admin&amp;action=show');
