...
/**
* matches
* The matches system of clansuite
*
* PHP >= version 5.1.4
*
* LICENSE:
...
class module_matches_admin
{
    ...
    */
    ...
    /**
    * @desc This content can be instantly displayed by adding {mod name="matches" sub="admin" func="instant_show" params="mytext"} into a template
