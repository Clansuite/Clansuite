...
// {mod name="matches" func="show" sub="mysubmodule" params="myparams"}
// 
...
$info['timestamp']      = 1171003244;
$info['name']           = 'matches';
$info['title']          = 'Matches';
$info['description']    = 'The matches system of clansuite';
$info['class_name']     = 'module_matches';
$info['file_name']      = 'matches.module.php';
$info['folder_name']    = 'matches';
$info['image_name']     = 'module_matches.jpg';
