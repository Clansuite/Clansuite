...
/**
* Modulename:   matches
* Description:  The matches system of clansuite
*
* PHP >= version 5.1.4
*
* LICENSE:
...
// Begin of class module_matches
class module_matches
{
    public $output          = '';
    ...
    /**
    * @desc General Function Hook of matches-Modul
    *
    ...
    * {mod name="matches" func="instant_show" params="mytext"}
    *
