...
/**
* messaging
* The messaging module of clansuite
*
* PHP >= version 5.1.4
*
* LICENSE:
...
class module_messaging_admin
{
    ...
    */
    ...
    /**
    * @desc This content can be instantly displayed by adding {mod name="messaging" sub="admin" func="instant_show" params="mytext"} into a template
