...
// {mod name="messaging" func="show" sub="mysubmodule" params="myparams"}
// 
...
$info['timestamp']      = 1171003530;
$info['name']           = 'messaging';
$info['title']          = 'Messaging';
$info['description']    = 'The messaging module of clansuite';
$info['class_name']     = 'module_messaging';
