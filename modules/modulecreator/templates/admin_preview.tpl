...
<div class="td_header_small">
    Frontend <span style="color: #cc0000;">/modules/{$mod.module_name}/{$mod.module_name}.class.php</span> - <a href="javascript:void(0);" class="scaler" id="frontend">{t}Increase view{/t}</a>
</div>
