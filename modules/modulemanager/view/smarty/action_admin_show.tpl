...
<table cellpadding="0" cellspacing="0" border="0" width="100%">
    ...
    <tr>
        ...
        <td class="cell2">
            ...
            *}
            <a href="/index.php?mod=templatemanager&amp;sub=admin&amp;action=showmoduletemplates&amp;tplmod={$module.name}" type="button" class="delete" title="Edit Templates">Edit Templates</a>
