...
class module_replays_admin
{
    ...
    */
    ...
    /**
    * @desc This content can be instantly displayed by adding {mod name="replays" sub="admin" func="instant_show" params="mytext"} into a template
