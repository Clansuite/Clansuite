...
/**
* Modulename:   replays
* Description:  The replays area of clansuite
*
* PHP >= version 5.1.4
*
* LICENSE:
...
// Begin of class module_replays
class module_replays
{
    public $output          = '';
    ...
    /**
    * @desc General Function Hook of replays-Modul
    *
    ...
    * {mod name="replays" func="instant_show" params="mytext"}
    *
