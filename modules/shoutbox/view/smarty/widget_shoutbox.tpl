...
<div class="shoutbox_row">
	<div class="shoutbox_head">
		...
		<span class="shoutbox_mail"><a href="mailto:{$shoutbox.mail}"><img src="{$www_root_themes}core/images/icons/email_open_image.png" border="0" alt="Icon Open Email"/></a></span>
	</div>
