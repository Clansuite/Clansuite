...
$modulenavigation = array(
                            '1' => array(
                                            'action'  => 'show',
                                            'name'    => 'Overview',
                                            'url'      => 'index.php?mod=statistics&sub=admin', # &action=show
                                            'icon'    => '',
                                            'title' => ''
                                        ),
                            ...
                            '2' => array(
                                            'action'  => 'create',
                                            'name'    => 'Create new',
                                            'url'     => 'index.php?mod=statistics&sub=admin&action=create',
                                            'icon'    => '',
                                            'title' => ''
                                        ),
                            ...
                            '3' => array(
                                            'action'  => 'settings',
                                            'name'    => 'Settings',
                                            'url'     => 'index.php?mod=statistics&sub=admin&action=settings',
                                            'icon'    => '',
                                            'title' => ''
                                        ),
                         );
