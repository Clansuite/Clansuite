{* Include für TSViewer einfügen *}

{*
include("http://www.tsviewer.com/ts_viewer_pur.php?ID=XXXXX&bg=XXXXXX&type=XXXXXX&type_size=X&type_family=X&info=X&channels=X&users=X");
*}
