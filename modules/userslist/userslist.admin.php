...
class module_userslist_admin
{
    ...
    /**
     * General Function Hook of userslist-Modul
     *
    ...
    function auto_run()
    {
        ...
        $trail->addStep($lang->t('userslist'), '/index.php?mod=userslist&amp;sub=admin');
        ...
        switch ($_REQUEST['action'])
        {
            ...
            default:
            case 'show':
                $trail->addStep($lang->t('Show'), '/index.php?mod=userslist&amp;sub=admin&action=show');
                $this->show();
                break;
    ...
    /**
     * Action -> Show
     * Direct Call by URL/index.php?mod=userslist&sub=admin&action=show
     *
    ...
    function show()
    {
        ...
        $this->output .= $lang->t('This is the admin submodule: module_userslist_admin. Place Administration of the Module here.');
    }
