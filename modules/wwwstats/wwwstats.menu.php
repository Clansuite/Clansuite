...
$modulenavigation = array(
                            '1' => array(
                                            'action'  => 'show',
                                            'name'    => 'Overview',
										    'url'	  => 'index.php?mod=wwwstats&sub=admin', # &action=show
										    'icon'    => '',
										    'tooltip' => ''
										),
							...
							'2' => array(
							                'action'  => 'create',
							                'name'    => 'Create new',
										    'url'     => 'index.php?mod=wwwstats&sub=admin&action=create',
										    'icon'    => '',
										    'tooltip' => ''
										),
						    ...
						    '3' => array(
							                'action'  => 'settings',
							                'name'    => 'Settings',
										    'url'     => 'index.php?mod=wwwstats&sub=admin&action=settings',
										    'icon'    => '',
										    'tooltip' => ''
										),
						 );
