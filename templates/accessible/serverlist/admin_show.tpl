{doc_raw}
<script src="{$www_root_tpl_core}/javascript/prototype.js" type="text/javascript"></script>
<script src="{$www_root_tpl_core}/javascript/scriptaculous.js" type="text/javascript"></script>
                   ...
                   <input type="hidden" name="ids[]" value="{$server.server_id}" />
                    ...
                    <td align="center">
                        {if $server.image_country==''}
                            <img src="{$www_root_tpl_core}/images/empty.png" width="16" height="16" class="border3d">
                        {else}
