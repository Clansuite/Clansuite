    ...
    <table cellpadding="0" cellspacing="0" border="0" align="center" width="500">
        ...
        <tr class="tr_row1">
            ...
            <td align="center">
                ...
                {else}
                    <img src="{$www_core_tpl_root}/images/categories/icons/{$smarty.post.info.icon|escape:"html"}" id="insert_icon" border="0" width="16" height="16" class="border3d"> 
                {/if}            
            </td>
        </tr>
        ...
        <tr class="tr_row2">
            ...
            <td align="center">
                ...
                {else}
                    <img src="{$www_core_tpl_root}/images/categories/images/{$smarty.post.info.image|escape:"html"}" id="insert_image" border="0" width="48" height="48" class="border3d"> 
                {/if}
            </td>
        </tr>                
