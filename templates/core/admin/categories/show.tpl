...
<form action="index.php?mod=admin&amp;sub=categories&amp;action=delete" method="post">
    <table cellpadding="0" cellspacing="0" border="0" width="700" align="center">
        ...
        <tr class="{cycle values="tr_row1,tr_row2"}">
            ...
            {else}
                <img src="{$www_core_tpl_root}/images/categories/icons/{$categories.icon}" alt="" class="border3d" />
            {/if}
            </td>
            <td align="center">
            {if $categories.image==''}
                <img src="{$www_core_tpl_root}/images/empty.png" class="border3d" alt="48x48" />
            {else}
