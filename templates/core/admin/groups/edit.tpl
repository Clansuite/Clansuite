...
<form target="_self" method="post" action="index.php?mod=admin&amp;sub=groups&amp;action=edit">
    <table cellpadding="0" cellspacing="0" border="0" style="width:500px;margin:0 auto;text-align:center">
        ...
        <tr class="tr_row1">
            ...
            <td width="1">
               <select class="input_text" name="info[icon]" onchange="document.getElementById('insert_icon').src='{$www_core_tpl_root}/images/groups/icons/'+document.getElementById('icon').options[document.getElementById('icon').options.selectedIndex].text" id="icon">
                    <option value=""></option>
        ...
        <tr class="tr_row2">
            ...
            <td width="1">
               <select class="input_text" name="info[image]" onchange="document.getElementById('insert_image').src='{$www_core_tpl_root}/images/groups/images/'+document.getElementById('image').options[document.getElementById('image').options.selectedIndex].text" id="image">
                    <option value=""></option>
            ...
            <td style="padding: 0px;" width="150">
                {foreach key=area_name item=area_array from=$info.areas}
                    <table style="display: none;" id="area_{$area_name}" cellpadding="0" cellspacing="0" border="0" width="100%">
                        <tr class="tr_row2"><td colspan="2"><b>{$area_name}</b></td></tr>
