<form action="index.php?mod=admin&amp;sub=groups&amp;action=delete" method="post">
    <table cellpadding="0" cellspacing="0" border="0" style="width:700px;margin:0 auto;text-align:center">
        ...
        <tr class="{cycle values="tr_row1,tr_row2"}">
            ...
            <td>
                {if $group.icon==''}
                <img src="{$www_core_tpl_root}/images/empty.png" alt="" class="border3d" />
                {else}
                <img src="{$www_core_tpl_root}/images/groups/icons/{$group.icon}" alt="" class="border3d" />
                {/if}
            </td>
            <td>
                {if $group.image==''}
                <img src="{$www_core_tpl_root}/images/empty.png" alt="" class="border3d" />
                {else}
                <img src="{$www_core_tpl_root}/images/groups/images/{$group.image}" alt="" class="border3d" />
                {/if}
            </td>
