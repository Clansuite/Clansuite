...
<form action="/index.php?mod=admin&sub=admin_modules&action=chmod&type=modules" method="POST">
...
<form action="/index.php?mod=admin&sub=admin_modules&action=chmod&type=uploads" method="POST">
<div id="cell1" align="center">
