...
<form action="{$www_root}/index.php?mod=admin&sub=modules&action=chmod&type=modules" method="POST">
...
<form action="{$www_root}/index.php?mod=admin&sub=modules&action=chmod&type=uploads" method="POST">
<div id="cell1" align="center">
