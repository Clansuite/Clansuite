...
{doc_raw}
    ...
    function node_click(id)
    {
        if( document.getElementById('section-' + id).style.display == 'none' )
        {
            ...
            document.getElementById('node-' + id).src = '{/literal}{$www_root_tpl_core}{literal}/admin/adminmenu/images/tree-node-open.gif';
        }
        else
        {
            document.getElementById('section-' + id).style.display = 'none';
            document.getElementById('node-' + id).src = '{/literal}{$www_root_tpl_core}{literal}/admin/adminmenu/images/tree-node.gif';
        }
    }
...
<form action="index.php?mod=admin&amp;sub=modules&amp;action=export" method="post" accept-charset="UTF-8">
                            ...
                            <div class="wrap1">
                                ...
                                <div class="wrap2" id="tree">
                                    {foreach key=key item=item from=$sql_tables}
                                        <div class='doc'>
                                            <img src="{$www_root_tpl_core}/admin/adminmenu/images/tree-leaf.gif" width="18" height="18" border="0">
                                            <input type="checkbox" name="tables[{$wert.name}][]" value="{$item}" />
                                            <img src="{$www_root_tpl_core}/admin/adminmenu/images/tree-doc.gif" width="18" height="18" border="0">
                                            {$item}
                                        </div>
                                    {/foreach}
                                </div>
