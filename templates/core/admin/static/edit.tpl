...
{if $err.static_already_exist == 1}
    ...
    {/error}
{/if}
<form action="{$www_root}/index.php?mod=admin&sub=static&action=edit" method="POST" target="_self">
<table border="0" cellspacing="0" cellpadding="0" width="100%">
    ...
    <tr>
        <td colspan="2" id="cell2" align="center">
            <input class="input_submit" type="submit" name="submit" value="{translate}Edit the static page{/translate}" />
        </td>
    </tr>
</table>
