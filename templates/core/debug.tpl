...
<span id="container_1" style="{if $debug_popup==0}display: block{else}display: none{/if};">
	...
	<table border="0" width="100%" bgcolor="#ECE9D8" style="border: thin solid black; border-color: #ffffff #ACA899 #ACA899 #ffffff;padding: 10px;">
	<tr style="border-color: #ffffff #ACA899 #ACA899 #ffffff;"><th colspan=2>clansuite Debug Console</th></tr>

		
	<tr style="border-color: #ffffff #ACA899 #ACA899 #ffffff;"><td colspan=2><b><a style="text-decoration: none;" href="javascript:clip('8')">$error->error_log: Advanced Error Logging</a></b></td></tr>
	...
	<tr style="border-color: #ffffff #ACA899 #ACA899 #ffffff;"><td colspan=2><b><a style="text-decoration: none;" href="javascript:clip('1')">Included templates & config files (load time in seconds):</a></b></td></tr>
	...
	<tr style="border-color: #ffffff #ACA899 #ACA899 #ffffff;"><td colspan=2><b><a style="text-decoration: none;" href="javascript:clip('2')">$tpl->assign(): Assigned template variables:</a></b></td></tr>
	...
	<tr style="border-color: #ffffff #ACA899 #ACA899 #ffffff;"><td colspan=2><b><a style="text-decoration: none;" href="javascript:clip('3')">Assigned config file variables (outer template scope):</a></b></td></tr>
	...
	<tr style="border-color: #ffffff #ACA899 #ACA899 #ffffff;"><td colspan=2><b><a style="text-decoration: none;" href="javascript:clip('11')">$db: All Queries, Prepares, Execs</a></b></td></tr>
	...
	<tr style="border-color: #ffffff #ACA899 #ACA899 #ffffff;"><td colspan=2><b><a style="text-decoration: none;" href="javascript:clip('4')">$_REQUEST: Incoming Variables</a></b></td></tr>
	...
	<tr style="border-color: #ffffff #ACA899 #ACA899 #ffffff;"><td colspan=2><b><a style="text-decoration: none;" href="javascript:clip('5')">$_SESSION: Session Variables</a></b></td></tr>
	...
	<tr style="border-color: #ffffff #ACA899 #ACA899 #ffffff;"><td colspan=2><b><a style="text-decoration: none;" href="javascript:clip('6')">$_COOKIES: Session Variables</a></b></td></tr>
	...
	<tr style="border-color: #ffffff #ACA899 #ACA899 #ffffff;"><td colspan=2><b><a style="text-decoration: none;" href="javascript:clip('7')">$cfg: Configuration (Password hidden)</a></b></td></tr>
	...
	<tr style="border-color: #ffffff #ACA899 #ACA899 #ffffff;"><td colspan=2><b><a style="text-decoration: none;" href="javascript:clip('9')">$lang->loaded: Loaded Language Files</a></b></td></tr>
	...
	<tr style="border-color: #ffffff #ACA899 #ACA899 #ffffff;"><td colspan=2><b><a style="text-decoration: none;" href="javascript:clip('10')">$modules->loaded: Loaded Modules</a></b></td></tr>
