...
class TestOfDirectRoute extends UnitTestCase
{
    ...
    public function testDefaultDeleteRequest()
    {
        $socket = new MockSimpleSocket();
    ...
    public function testDefaultHeadRequest()
    {
        $socket = new MockSimpleSocket();
...
class TestOfHttpRequest extends UnitTestCase
{
    ...
    public function testReadingDeleteConnection()
    {
        $socket = new MockSimpleSocket();
...
class TestOfHttpPostRequest extends UnitTestCase
{
    ...
    public function testContentHeadersCalculatedWithUrlEncodedParams()
    {
        $socket = new MockSimpleSocket();
    ...
    public function testContentHeadersCalculatedWithRawEntityBody()
    {
        $socket = new MockSimpleSocket();
