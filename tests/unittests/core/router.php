...
class Clansuite_Router_Test extends Clansuite_UnitTestCase
{
    ...
    function testMethod_match_StaticRoute()
    {
        ...
        $this->assertEqual('Clansuite_Module_Account',  $route->getClassname());
        ...
        $this->assertEqual('Clansuite_Module_Index',    $route->getClassname());
    ...
    function testMethod_match_RestRoutes()
    {
        ...
        $this->assertEqual('Clansuite_Module_News', $route->getClassname());
