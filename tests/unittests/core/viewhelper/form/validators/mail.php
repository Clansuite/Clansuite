<?php
class Clansuite_Formelement_Validator_Email_Test extends Clansuite_UnitTestCase
{
    /**
     * @var Clansuite_Formelement_Validator_Email
     */
    protected $validator;
    ...
    {
        # Test Subject
        require_once TESTSUBJECT_DIR . 'core/viewhelper/form/validators/mail.php';
        $this->validator = new Clansuite_Formelement_Validator_Email;
    }
