<?php
class Clansuite_Formelement_Validator_Maxvalue_Test extends Clansuite_UnitTestCase
{
    /**
     * @var Clansuite_Formelement_Validator_maxvalue
     */
    protected $validator;
    ...
    {
        # Test Subject
        require_once TESTSUBJECT_DIR . 'core/viewhelper/form/validators/maxvalue.php';
        $this->validator = new Clansuite_Formelement_Validator_Maxvalue;
    }
