...
<table cellpadding="0" cellspacing="0" border="0" id="profile" width="100%">
    ...
    <tr>
        <td class="cell2">
            <div class="profile_icon"><img src="{$www_root_themes}/images/icons/page_edit.png" border="0" width="16" height="16" /></div>
        </td>
        <td class="cell2">
            {t}First name{/t}
        </td>
    ...
    <tr>
        <td class="cell2">
            <div class="profile_icon"><img src="{$www_root_themes}/images/icons/cake.png" border="0" width="16" height="16" /></div>
        </td>
        <td class="cell2">
            {t}Birthday{/t}
        </td>
    ...
    <tr>
        <td class="cell2">
            <div class="profile_icon"><img src="{$www_root_themes}/images/icons/male.png" border="0" width="16" height="16" /></div>
        </td>
        <td class="cell2">
            {t}Gender{/t}
        </td>
    ...
    <tr>
        <td class="cell2">
            <div class="profile_icon"><img src="{$www_root_themes}/images/icons/text_linespacing.png" border="0" width="16" height="16" /></div>
        </td>
        <td class="cell2">
            {t}Height{/t}
        </td>
    ...
    <tr>
        <td class="cell2">
            <div class="profile_icon"><img src="{$www_root_themes}/images/icons/book.png" border="0" width="16" height="16" /></div>
        </td>
        <td class="cell2">
            {t}Address{/t}
        </td>
    ...
    <tr>
        <td class="cell2">
            <div class="profile_icon"><img src="{$www_root_themes}/images/icons/vcard.png" border="0" width="16" height="16" /></div>
        </td>
        <td class="cell2">
            {t}ZIP code{/t}
        </td>
    ...
    <tr>
        <td class="cell2">
            <div class="profile_icon"><img src="{$www_root_themes}/images/icons/house.png" border="0" width="16" height="16" /></div>
        </td>
        <td class="cell2">
            {t}City{/t}
        </td>
    ...
    <tr>
        <td class="cell2">
            <div class="profile_icon"><img src="{$www_root_themes}/images/icons/world.png" border="0" width="16" height="16" /></div>
        </td>
        <td class="cell2">
            {t}Country{/t}
        </td>
    ...
    <tr>
        <td class="cell2">
            <div class="profile_icon"><img src="{$www_root_themes}/images/icons/html.png" border="0" width="16" height="16" /></div>
        </td>
        <td class="cell2">
            {t}Homepage{/t}
        </td>
    ...
    <tr>
        <td class="cell2">
            <div class="profile_icon"><img src="{$www_root_themes}/images/icons/icq.png" border="0" width="16" height="16" /></div>
        </td>
        <td class="cell2">
            {t}ICQ{/t}
        </td>
    ...
    <tr>
        <td class="cell2">
            <div class="profile_icon"><img src="{$www_root_themes}/images/icons/msn.png" border="0" width="16" height="16" /></div>
        </td>
        <td class="cell2">
            {t}MSN{/t}
        </td>
    ...
    <tr>
        <td class="cell2">
            <div class="profile_icon"><img src="{$www_root_themes}/images/icons/skype.png" border="0" width="16" height="16" /></div>
        </td>
        <td class="cell2">
            {t}Skype{/t}
        </td>
    ...
    <tr>
        <td class="cell2">
            <div class="profile_icon"><img src="{$www_root_themes}/images/icons/telephone.png" border="0" width="16" height="16" /></div>
        </td>
        <td class="cell2">
            {t}Phone{/t}
        </td>
    ...
    <tr>
        <td class="cell2">
            <div class="profile_icon"><img src="{$www_root_themes}/images/icons/phone.png" border="0" width="16" height="16" /></div>
        </td>
        <td class="cell2">
            {t}Mobile{/t}
        </td>
    ...
    <tr>
        <td class="cell2">
            <div class="profile_icon"><img src="{$www_root_themes}/images/icons/application_view_list.png" border="0" width="16" height="16" /></div>
        </td>
        <td class="cell2">
            {t}Custom Text{/t}
        </td>
